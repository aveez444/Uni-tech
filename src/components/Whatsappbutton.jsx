...
const WhatsAppButton = () => {
  const phoneNumber = "+918999037958"; // Replace with actual number
  const message = "Hello, we're interested in exploring partnership opportunities with UNI-TECH INTERNATIONAL for rubber product supplies. Can we discuss pricing, delivery, and customization details?";
