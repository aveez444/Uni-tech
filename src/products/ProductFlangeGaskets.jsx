...
import flangeGasketImage1 from '../assets/flange-gasket-1.jpg';
import flangeGasketImage2 from '../assets/flange-gasket-2.jpg';

const ProductFlangeGaskets = () => {
  ...
  const product = {
    name: "Custom Flange Gaskets & Pipes",
    shortName: "Flange Gaskets",
    description: "High-performance custom flange gaskets and pipes engineered for superior sealing in industrial, petrochemical, and piping applications.",
    fullDescription: "Uni-Tech Auto International's custom flange gaskets are precision-engineered to provide reliable sealing solutions for complex piping systems. Our gaskets ensure leak-proof performance under extreme pressures, temperatures, and chemical exposures, making them ideal for critical industrial applications.",
    
    images: [flangeGasketImage1, flangeGasketImage2],
    
    features: [
      { icon: Shield, title: "Leak-Proof Sealing", desc: "Superior compression and recovery for zero-leak performance" },
      { icon: Thermometer, title: "High Temperature", desc: "Operates from -200°C to 1000°C depending on material" },
      { icon: Droplets, title: "Chemical Resistant", desc: "Withstands aggressive chemicals, acids, and solvents" },
      { icon: Zap, title: "High Pressure", desc: "Rated for pressures up to 10,000 PSI" }
    ],

    specifications: {
      sizes: "DN15 to DN2000 (½\" to 80\")",
      thickness: "0.5mm to 20mm",
      materials: ["Non-Asbestos", "Graphite", "PTFE", "Rubber", "Metal Jacketed", "Spiral Wound"],
      standards: ["ASME B16.20", "ASME B16.21", "DIN 2690", "ISO 7483", "API 6A"],
    ...
    benefits: [
      "Custom-designed for specific flange types",
    ...
    materialProperties: [
      {
        material: "Graphite Gaskets",
        tempRange: "-200°C to 500°C",
        features: "Excellent thermal conductivity and chemical resistance",
        applications: "Heat exchangers, boilers, high-temperature services"
      },
      {
        material: "PTFE Gaskets",
        tempRange: "-100°C to 260°C",
        features: "Outstanding chemical resistance, non-stick properties",
        applications: "Chemical processing, pharmaceutical, food industry"
      },
      {
        material: "Rubber Gaskets",
        tempRange: "-50°C to 120°C",
        features: "Good flexibility and compression",
        applications: "Water systems, low-pressure applications"
      },
      {
        material: "Spiral Wound",
        tempRange: "-100°C to 800°C",
        features: "High pressure and temperature capability",
        applications: "Oil and gas, power plants, refineries"
      }
    ],
    ...
    qualityAssurance: [
      ...
      "Traceability for all materials",
    ...
    >
      ...
      <motion.div variants={itemVariants} className="space-y-4 md:space-y-6">
        ...
        <div className="grid grid-cols-3 gap-3 md:gap-4 pt-4 md:pt-6">
          {[
            { icon: Clock, value: "72h", label: "Prototype Delivery" },
            { icon: Shield, value: "ASME", label: "Certified" },
            { icon: Package, value: "Custom", label: "Sizes Available" }
          ].map((stat, index) => (
            <motion.div
              key={index}
              whileHover={{ scale: 1.05 }}
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                >
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    {product.fullDescription} Our custom flange gaskets are manufactured using 
                    advanced CNC cutting, laser cutting, and precision molding techniques to 
                    ensure perfect fit and optimal sealing performance.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    With extensive experience in industrial sealing solutions, Uni-Tech Auto International 
                    provides custom gasket designs that meet the most demanding specifications for 
                    pressure, temperature, and chemical compatibility in critical applications.
                  </p>
                </motion.div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <h2 className="text-4xl font-bold text-white mb-4">
                Need Custom Flange Gaskets?
              </h2>
              <p className="text-xl text-blue-200 mb-8">
                Our engineering team can design gaskets for your specific requirements.
              </p>
...
// Inquiry Modal Component (same as O-rings)
    ...
    >
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-t-3xl p-6 text-white">
          ...
          <p className="text-blue-100">Our engineering team will contact you within 4 hours</p>
        </div>
        ...
        <form onSubmit={onSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={onChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                placeholder="e.g., 500 sets/month"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={onChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                placeholder="How will you use the gaskets?"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Flange size, pressure rating, temperature, material preference..."
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 resize-none"
              placeholder="Any other technical requirements or drawings available..."
            />
          </div>
...
export default ProductFlangeGaskets;