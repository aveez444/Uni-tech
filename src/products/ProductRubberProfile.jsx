...
import profileImage1 from '../assets/rubber-profile.jpg';
import profileImage2 from '../assets/rubber-profiles-2.jpg';

const ProductRubberProfile = () => {
  ...
  const product = {
    name: "Custom Rubber Profiles & Extrusions",
    shortName: "Rubber Profiles",
    description: "Precision-engineered rubber profiles and extrusions for sealing, trimming, and protection applications across various industries.",
    fullDescription: "Uni-Tech Auto International specializes in manufacturing high-quality rubber profiles and extrusions tailored to your specific requirements. Our custom profiles are designed for perfect fit and function in automotive, construction, industrial, and consumer applications. Using advanced extrusion technology, we produce consistent, high-quality profiles with excellent dimensional stability and material properties.",
    
    images: [profileImage1, profileImage2],
    
    features: [
      { icon: Ruler, title: "Custom Shapes", desc: "Any complex profile geometry manufactured to specification" },
      { icon: Shield, title: "Durable Sealing", desc: "Excellent weather resistance and long-term performance" },
      { icon: Thermometer, title: "Temperature Resistant", desc: "Operates in extreme temperatures from -60°C to 200°C" },
      { icon: Scissors, title: "Precision Cut", desc: "Accurate cutting to length with various joining methods" }
    ],

    specifications: {
      profiles: "Custom shapes and dimensions",
      length: "Continuous lengths up to 25 meters",
      thickness: "0.5mm to 50mm cross-section",
      materials: ["EPDM", "Silicone (VMQ)", "NBR (Nitrile)", "Neoprene", "Natural Rubber", "SBR"],
      hardness: "30° to 90° Shore A",
      tolerance: "±0.1mm to ±0.5mm depending on profile complexity"
    },

    applications: [
      "Automotive door and window seals",
      "Construction glazing and expansion joints",
      "Appliance gaskets and seals",
      "Marine hatch and port seals",
      "Industrial equipment protection",
      "HVAC duct sealing systems",
      "Electrical enclosure seals",
      "Furniture edge trim and protection"
    ],

    benefits: [
      "Custom-designed for perfect application fit",
      "Excellent weather and UV resistance",
      "Superior compression set resistance",
      "Cost-effective for long production runs",
      "Consistent quality throughout entire length",
      "Quick prototyping and sample development"
    ],
    ...
    materialProperties: [
      {
        ...
        applications: "Automotive seals, construction joints, outdoor applications"
      },
      {
        material: "Silicone",
        tempRange: "-60°C to 230°C",
        features: "High temperature stability, food-grade options",
        applications: "High-temperature seals, medical, food industry"
      },
      {
        material: "NBR (Nitrile)",
        tempRange: "-40°C to 120°C",
        features: "Superior oil and fuel resistance",
        applications: "Fuel systems, oil-resistant seals, industrial applications"
      },
      {
        material: "Neoprene",
        tempRange: "-40°C to 100°C",
        features: "Good weather and flame resistance",
        applications: "Weather seals, marine applications, industrial uses"
      }
    ],
    ...
    profileTypes: [
      {
        type: "Solid Profiles",
        description: "Dense rubber profiles for sealing and structural applications",
        examples: "Door seals, window gaskets, edge trims"
      },
      {
        type: "Sponge/Cellular Profiles",
        description: "Closed-cell profiles for superior compression and insulation",
        examples: "Weather stripping, thermal seals, acoustic insulation"
      },
      {
        type: "Co-extruded Profiles",
        description: "Multiple materials combined for enhanced functionality",
        examples: "Hard/soft combinations, colored inserts, mounting strips"
      },
      {
        type: "Metal-Rubber Profiles",
        description: "Rubber extruded over metal carriers for structural support",
        examples: "Automotive glass runs, structural seals, mounting channels"
      }
    ],
    ...
    qualityAssurance: [
      ...
      "Consistent cross-section monitoring"
    ]
  };
              ...
              <motion.div variants={itemVariants} className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4 pt-6">
                  {[
                    ...
                    { icon: Ruler, value: "Custom", label: "Profiles" }
                  ].map((stat, index) => (
                    <motion.div
                      key={index}
                      whileHover={{ scale: 1.05 }}
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                >
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    {product.fullDescription} We utilize modern extrusion equipment and tooling 
                    to produce profiles with tight tolerances and excellent surface finish.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    Whether you need simple seals or complex multi-material profiles, our 
                    engineering team can develop solutions that meet your exact specifications 
                ...
                >
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Profile Types</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {product.profileTypes.map((profile, index) => (
                      ...
                      >
                        <h3 className="font-bold text-lg text-gray-900 mb-3">{profile.type}</h3>
                        <p className="text-gray-700 text-sm mb-3">{profile.description}</p>
                        <div className="text-sm text-blue-600">
                          <strong>Examples:</strong> {profile.examples}
                        </div>
                      </motion.div>
                    ))}
                  </div>
                ...
                >
                  ...
                  <div className="bg-gray-50 rounded-2xl p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-3">Dimensions & Properties</h3>
                        <div className="space-y-2">
                          <div className="flex justify-between py-2 border-b border-gray-200">
                            <span className="text-gray-600">Profile Types</span>
                            <span className="font-semibold">{product.specifications.profiles}</span>
                          </div>
                          <div className="flex justify-between py-2 border-b border-gray-200">
                            <span className="text-gray-600">Maximum Length</span>
                            <span className="font-semibold">{product.specifications.length}</span>
                          </div>
                          <div className="flex justify-between py-2 border-b border-gray-200">
                          ...
                          <div className="flex justify-between py-2 border-b border-gray-200">
                            <span className="text-gray-600">Hardness Range</span>
                            <span className="font-semibold">{product.specifications.hardness}</span>
                          </div>
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="mt-4">
                            <h4 className="text-sm font-medium text-gray-700">Tolerance:</h4>
                            <div className="mt-1">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <h2 className="text-4xl font-bold text-white mb-4">
                Need Custom Rubber Profiles?
              </h2>
              <p className="text-xl text-blue-200 mb-8">
                Contact our extrusion experts for custom designs, material selection, and competitive pricing.
              </p>
        ...
        <form onSubmit={onSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={onChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                placeholder="e.g., 500 meters/month"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={onChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                placeholder="How will you use the rubber profiles?"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Profile shape, dimensions, material, hardness, color, etc..."
            />
          </div>
...
export default ProductRubberProfile;