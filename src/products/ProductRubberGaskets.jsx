...
// Import images
import gasketImage1 from '../assets/rubber-gaskets.jpg';
// If you have another gasket image, import it here; otherwise reuse the same image:
import gasketImage2 from '../assets/rubber-gaskets2.jpg';

const ProductRubberGaskets = () => {
  ...
  const product = {
    name: "Precision Rubber Gaskets",
    shortName: "Rubber Gaskets",
    description: "Leak-proof rubber gaskets engineered for static sealing in automotive, industrial, and plumbing systems.",
    fullDescription: "Uni-Tech Auto International's rubber gaskets are manufactured to deliver dependable, long-lasting sealing in static applications. Available as cut gaskets or molded shapes, our gaskets are designed to resist chemicals, oils, and high compression loads while providing excellent aging and weathering resistance.",
    images: [gasketImage1, gasketImage2],
    features: [
      { icon: Shield, title: "Leak-Proof Sealing", desc: "Reliable sealing for fluids, gases and aggressive media" },
      { icon: Thermometer, title: "Temperature Resistant", desc: "Handles a broad temperature range depending on elastomer" },
      { icon: Droplets, title: "Chemical Compatible", desc: "Resistant to oils, fuels, coolants and many chemicals" },
      { icon: Package, title: "Customizable", desc: "Cut, molded or die-cut to your drawing/spec" }
    ],
    specifications: {
      sizes: "Custom cut to customer requirements (any gasket profile/OD/ID)",
      thickness: "0.5mm to 50mm",
      materials: ["NBR (Nitrile)", "EPDM", "Silicone (VMQ)", "Viton (FKM)", "Neoprene", "Natural Rubber"],
      standards: ["ASTM D2000", "ISO 3601 (where applicable)", "DIN / JIS on request"],
      tolerance: "±0.1mm to ±0.5mm depending on geometry"
    },
    applications: [
      "Pipe flanges and couplings",
      "Engine housings and gearbox covers",
      "HVAC and refrigeration systems",
      "Pumps, valves and compressors",
      "Plumbing and water handling equipment",
      "Electrical enclosures and panels"
    ],
    benefits: [
      "Reliable leak prevention and service life",
      "Custom design to fit complex flanges & housings",
      "Reduced assembly & maintenance downtime",
      "Wide material selection for specific environments",
      "Available in small to high volume production"
    ],
    materialProperties: [
      {
        ...
        applications: "Fuel systems, oil-exposed gaskets"
      },
      {
        material: "EPDM",
        tempRange: "-50°C to 150°C",
        features: "Weather, ozone and steam resistant",
        applications: "Outdoor seals, water and steam systems"
      },
      {
        material: "Silicone",
        tempRange: "-60°C to 230°C",
        features: "High temperature and food-grade options",
        applications: "Food industry, high-temp housings"
      },
      {
        material: "Viton",
        tempRange: "-20°C to 200°C",
        features: "Superior chemical resistance",
        applications: "Chemical processing, aggressive fluids"
      }
    ],
    qualityAssurance: [
      "Dimensional verification and fit checks",
      "Material certificates available on request",
      "Batch traceability for production lots",
  ...
  const handleInquirySubmit = (e) => {
    e.preventDefault();
    // TODO: wire this to your backend / lead system
    ...
    >
      ...
      <motion.div variants={itemVariants} className="space-y-4 md:space-y-6">
        ...
        <div className="grid grid-cols-3 gap-3 md:gap-4 pt-4 md:pt-6">
          {[
            { icon: Clock, value: "48h", label: "Sample Delivery" },
            { icon: Shield, value: "ISO", label: "Certified" },
            { icon: Package, value: "Custom", label: "Cut & Molded" }
          ].map((stat, index) => (
            <motion.div
              key={index}
              whileHover={{ scale: 1.05 }}
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                >
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    {product.fullDescription} We provide both standard gasket sizes and fully custom solutions — cut, molded, or die-cut — per your drawings or samples.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    Our production uses controlled curing and finishing to ensure consistent hardness and dimensional accuracy across batches.
                  </p>
                </motion.div>
        ...
        <form onSubmit={onSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={onChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                placeholder="How will you use the gasket?"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Material, thickness, OD/ID, tolerances, standards..."
            />
          </div>
...
export default ProductRubberGaskets;
